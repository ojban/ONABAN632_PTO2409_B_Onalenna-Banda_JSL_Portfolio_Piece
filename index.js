...
function displayBoards(boards) {
  ...
  boards.forEach((board) => {
    ...
    boardElement.addEventListener("click", () => {
      //🪲 added an event listener (just said boardElement.click)
    ...
    filteredTasks
      ...
      .forEach((task) => {
        ...
        taskElement.addEventListener("click", () => {
          //🪲 syntax error: added event listener
...
function setupEventListeners() {
  ...
  ); //🪲 added event listener. It said cancelEditBtn.click
